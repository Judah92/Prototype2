...
public class ManageCards : MonoBehaviour
{
    ...
    public void ShowCorrectAnswerPopup()
    {
        ...
        Invoke("HideCorrectAnswerPopup", 2f);//Calling (invoke) on the HideCorrectAnswerPopup with a 5 second delay
    }

    public void ShowWrongAnswerPopup()
    {
        wrongAnswerPopup.SetActive(true);
        Invoke("HideWrongAnswerPopup", 2f);//Calling (invoke) on the HideWrongAnswerPopup with a 5 second delay
    }
